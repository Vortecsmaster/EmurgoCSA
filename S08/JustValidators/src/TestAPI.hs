...
type LearnersAPI3 = "learners" :> "list-all" :> "now" :> Get '[JSON] [Learner]
...
type PostCreated = Verb 'POST 202

type UserAPI4 = "learners" :> Get '[JSON] [Learner]
...
type UserAPI7 = "learners" :> ReqBody '[JSON] User :> Post '[JSON] Learner
...
type LearnerAPI8 = "learners" :> Header "Learner-Agent" Text :> Get '[JSON] [Leaner]

type LearnerAPI9 = "learners" :> Get '[JSON, PlainText, FromUrlEncoded, OctetStream] [Learner]
...
type ProtectedAPI11 
    = LearnerAPI
    :<|> BasicAuth "my-realm" Leaner :> LearnerAPI2

type LearnerAPI12 innerAPI
    = LearnerAPI
    :<|> "inner" :> innerAPI

type LearnerAPI12Alone = LeanerAPI12 EmptyAPI
