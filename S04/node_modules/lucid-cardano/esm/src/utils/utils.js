...
export function applyParamsToScript(plutusScript, ...params) {
    return toHex(C.apply_params_to_plutus_script(C.PlutusList.from_bytes(fromHex(Data.to(params))), C.PlutusScript.from_bytes(fromHex(plutusScript))).to_bytes());
}
