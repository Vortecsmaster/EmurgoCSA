...
import { Address, AddressDetails, Assets, CertificateValidator, Credential, Datum, DatumHash, KeyHash, MintingPolicy, NativeScript, Network, PlutusData, PolicyId, PrivateKey, PublicKey, RewardAddress, Script, ScriptHash, Slot, SpendingValidator, Unit, UnixTime, UTxO, Validator, WithdrawalValidator } from "../types/mod.js";
...
export declare function applyParamsToScript(plutusScript: string, ...params: PlutusData[]): string;
